<template>
  <div class="monster-hunter">
    <div class="featured-image">
      <img src="/images/monster-hunter/monster hunter main.jpg" alt="Monster Hunter Main" class="main-image" @contextmenu.prevent @dragstart.prevent>
    </div>
    <div class="rotating-text-container">
      <div class="rotating-text">
        <span>Monster Hunter&nbsp;&nbsp;&nbsp;🐉&nbsp;&nbsp;&nbsp;Monster Hunter&nbsp;&nbsp;&nbsp;🐉&nbsp;&nbsp;&nbsp;Monster Hunter&nbsp;&nbsp;&nbsp;🐉&nbsp;&nbsp;&nbsp;</span>
        <span>Monster Hunter&nbsp;&nbsp;&nbsp;🐉&nbsp;&nbsp;&nbsp;Monster Hunter&nbsp;&nbsp;&nbsp;🐉&nbsp;&nbsp;&nbsp;Monster Hunter&nbsp;&nbsp;&nbsp;🐉&nbsp;&nbsp;&nbsp;</span>
      </div>
    </div>
...
const models = [
  {
    title: '',
    image: '/images/monster-hunter/monsterhunterside.jpg'
  }
];
